...
Ext.ux.Toast = function() {
    ...
    return {
		/**
		 * Shows popup ie6 bug 要设定 width:200px; 否则宽度为body宽度
		 * @member Ext.ux.Toast
		 * @param {String} title
		 * @param {String} format
		 */
        msg : function(title, format){
            if(!msgCt){
                msgCt = Ext.DomHelper.insertFirst(document.body, {id:'msg-div',style:'position:absolute; width:200px;z-index:10000'}, true);
            }
