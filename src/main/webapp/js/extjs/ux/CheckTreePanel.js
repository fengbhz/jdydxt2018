/**
 * modified by zhaozhi3758 2012-08-24
 * 
 * 注意：
 *  1 增加singleSelet属性
 *  2 preloadChildren 设置为 preloadChildren false(异步加载)
 */
...
Ext.ux.tree.CheckTreePanel = Ext.extend(Ext.tree.TreePanel, {
   ...
   /**
	...
	,initComponent:function() {
		 ...
		 * true不选择父级
		 */
		Ext.applyIf(Ext.ux.tree.CheckTreeNodeUI.prototype,{'singleSelet':this.singleSelet});
		...
		/**
		 * 修改preloadChildren为false，采用不预先加载全部节点
		 */
		Ext.applyIf(this.loader, {baseAttrs:baseAttrs, preloadChildren:this.preloadChildren});
